// Este será el núcleo del programa, la idea es setear la alarma, luego el funcionamiento del motor. 
// Este programa es de ejemplo para poder sacar la idea, se sacó el ejemplo de la página de arduino
